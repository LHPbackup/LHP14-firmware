...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case HC_HB:
      if (record->event.pressed) {
        SEND_STRING(SS_LALT("7") SS_LALT("8"));
      }
      break;
    case SE_SH:
      if (record->event.pressed) {
    ...
    case TK_GG:
      if (record->event.pressed) {
        SEND_STRING(SS_LALT("8") SS_LALT("9"));
      }
      break;
  }
  return true;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   [SAM] = LAYOUT( \
    ...
    LCA(KC_MINS),   XXXXXXX,   LCA(KC_MINS),KC_S,   LALT(KC_MINS),                       \
                                                             LALT(KC_3), KC_HASH,   \
                                                                         KC_F12     \
  ),
  ...
  [SCH] = LAYOUT( \
    ...
    XXXXXXX,   KC_Z,      LALT(KC_6), LALT(KC_5), LALT(KC_1), LCA(KC_7),  TO(SGE),   \
   ...
   * |------+------+------+------+------+------+------|   
   * |   A  |ｺﾝact1|ｴｳｸﾗｼｱ|堅実魔|ﾘｿﾞｰﾏﾀ|      | MNK  |   
   * |------+------+------+------+------+-------------'   
   * |      |      |      |   S  |ﾎｰﾘｽﾞﾑ|                 
   * `----------------------------------+-------------.          
   *                                    |ﾊﾟﾝﾊｲﾏ|JSPush|   
  ...
  [SGE] = LAYOUT( \
    ...
    KC_A,      KC_Z,      LALT(KC_6), LALT(KC_5), LALT(KC_1), XXXXXXX,    TO(MNK),   \
    XXXXXXX,   XXXXXXX,   XXXXXXX,    KC_S,       KC_UNDS,                           \
                                                              LALT(KC_0), JS_BUTTON0,\
                                                                          KC_F12     \
  ),
   ...
   */
   [MNK] = LAYOUT( \
    ...
    XXXXXXX,   LCA(KC_1), LCA(KC_9),   KC_AMPR,   TK_GG,    LALT(KC_0), TO(RPR),   \
    XXXXXXX,   XXXXXXX,   LCA(KC_MINS),KC_S,      KC_0,                            \
                                                             LCA(KC_2),  KC_HASH,   \
                                                                         KC_F12     \
  ),
   ...
   * |------+------+------+------+------+------+------|   
   * |      |ｸﾚｽﾄ  |ｱﾙｹﾌﾚﾊ|ｱﾑﾚﾝ  |ｼｬﾄﾞｳ |ALT-  | DRG  |   
   * |------+------+------+------+------+-------------'   
   * |      |      |ｺﾝact2|  S   |ｲｰｸﾞﾚ |                 
   * `----------------------------------+-------------.          
   *                                    |黙想  |ｸﾚｽﾄ  |   
  ...
  [DNC] = LAYOUT( \
    ...
    XXXXXXX,  KC_Z,      KC_LPRN,   LALT(KC_5), KC_AMPR,   XXXXXXX, TO(MCH),    \
  ...
  [MCH] = LAYOUT( \
    ...
    XXXXXXX,  KC_Z,      LALT(KC_4),LALT(KC_5), HC_HB,     XXXXXXX,   TO(WHM),    \
  ...
  [WHM] = LAYOUT( \
    ...
    XXXXXXX,   KC_Z,      LALT(KC_0), LALT(KC_6),    LALT(KC_MINUS),XXXXXXX,    TO(RDM),     \
    XXXXXXX,   XXXXXXX,   XXXXXXX,    XXXXXXX,       KC_UNDS,                                \
                                                                    KC_MINUS,   JS_BUTTON0,  \
                                                                                KC_F12       \
  ),
